      ...
      <div className="relative lg:bg-[#F9A834] min-h-[calc(100vh-80px)]  pt-12  px-4 sm:px-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/landing.png"
            alt="Hero Background"
            className="w-full lg:h-full h-[50%]   object-cover object-[100%_top] scale-100 animate-fade-in"
          />
        </div>
          ...
          <div className="w-full flex   justify-center lg:justify-start">
            <div className="w-full py-5  lg:w-[50%]">
              <p className="text-base sm:text-lg text-slate-600 max-w-lg mx-auto lg:mx-0 leading-relaxed px-4 lg:px-0">
                Engage customers instantly on WhatsApp <br /> with AI-powered
                chatbots that sell, support, <br />
                ...
                <div className="relative animate-float bg-transparent -ml-20 w-100 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-500">
                  <div className="bg-gradient-to-r from-indigo-600 to-blue-500 px-4 sm:px-6 py-2 sm:py-2 flex items-center justify-between">
                    ...
                    <div className="flex gap-2 sm:gap-3 text-white">
                      <button className="hover:bg-white/20 p-1 rounded text-sm sm:text-base">
                        ✕
                      </button>
                    </div>
                  </div>
        ...
        <div
          className="absolute bottom-20 right-10 w-64 sm:w-96 h-64 sm:h-96 bg-indigo-200/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>

        <div className="lg:w-[70%] lg:mx-30  grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10"></div>
      </div>
              ...
              >
                <div className="flex items-center gap-3 group cursor-pointer flex-shrink-0">
                  <div className="h-8 w-auto">
                    <svg
                      viewBox="0 0 635 262"
                      className="h-full fill-slate-400 group-hover:fill-[#635BFF] transition-colors"
                ...
                <div className="flex items-center gap-3 group cursor-pointer flex-shrink-0">
                  <div className="h-8 w-auto">
                    <svg
                      ...
                      className="h-full fill-slate-400 group-hover:fill-[#FF5A5F] transition-colors"
                      style={{ transition: "fill 0.3s" }}
                    >
                ...
                <div className="flex items-center gap-3 group cursor-pointer flex-shrink-0">
                  <div className="h-8 w-auto">
                    <svg
                      viewBox="0 0 245 240"
                      className="h-full fill-slate-400 group-hover:fill-[#5865F2] transition-colors"
                      style={{ transition: "fill 0.3s" }}
                    >
                ...
                <div className="flex items-center gap-3 group cursor-pointer flex-shrink-0">
                  <div className="h-8 w-auto">
                    <svg
                      viewBox="0 0 32 32"
                      className="h-full fill-slate-400 group-hover:fill-[#0073EA] transition-colors"
                      style={{ transition: "fill 0.3s" }}
                    >
                ...
                <div className="flex items-center gap-3 group cursor-pointer flex-shrink-0">
                  <div className="h-8 w-auto">
                    <svg
                      viewBox="0 0 24 24"
                      className="h-full fill-slate-400 group-hover:fill-[#E60023] transition-colors"
                      style={{ transition: "fill 0.3s" }}
                    >
                ...
                <div className="flex items-center gap-3 group cursor-pointer flex-shrink-0">
                  <div className="h-8 w-auto">
                    <svg
                      viewBox="0 0 24 24"
                      className="h-full fill-slate-400 group-hover:fill-[#00A4EF] transition-colors"
                      style={{ transition: "fill 0.3s" }}
                    >
        ...
        <div className="max-w-7xl  mx-auto grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-12 left-4 sm:left-12 grid grid-cols-4 gap-1 sm:gap-2 opacity-20">
              {[...Array(16)].map((_, i) => (
                <div
                  key={i}
                  className="w-1.5 sm:w-2 h-1.5 sm:h-2 bg-slate-900 rounded-full"
                ></div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-6  sm:space-y-8 order-1 lg:order-2 text-center lg:text-left px-4 sm:px-6 lg:px-0">
            ...
            <p className="text-base sm:text-lg text-slate-600 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium opacity-90">
              Transform how your business communicates with customers using
              AI-powered chatbots built for WhatsApp. YourSiteChat helps you
              respond instantly, automate support, and convert conversations
              into revenue — 24/7.
            </p>
            ...
            <ul className="space-y-3 sm:space-y-4 max-w-lg mx-auto lg:mx-0">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base text-slate-700 font-semibold"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            ...
            {[
              ...
              >
                {card.img && !card.solid && (
                  <div className="absolute inset-0">
                    <img
                      src={card.img}
                      alt={card.title}
                      className="w-full h-full object-cover opacity-40 sm:opacity-60 mix-blend-multiply group-hover:scale-110 transition-transform duration-700"
                    />
                  </div>
                )}
                {card.dark && card.img && (
                ...
                <div
                  className={`relative p-4 sm:p-6 md:p-8 h-full flex flex-col justify-start ${card.dark ? "text-white" : "text-slate-900"}`}
                >
                  <span
                    className={`text-[8px] sm:text-[10px] font-bold tracking-[0.1em] sm:tracking-[0.2em] ${card.dark ? "text-white/70" : "text-slate-900/70"} mb-2 sm:mb-4`}
                  >
                    {card.tag}
                  </span>
                  ...
                  <p
                    className={`text-xs sm:text-sm leading-relaxed font-medium ${card.dark ? "text-white/80" : "text-slate-700"}`}
                  >
                    {card.desc}
                  </p>
                </div>
