...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="lg:w-[70%] lg:mx-30 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
          ...
          <div className="relative animate-slide-in-right lg:pr-0 px-4 sm:px-6 lg:px-0 mt-8 lg:mt-0">
            <div className="relative mx-auto w-full max-w-md">
              ...
              <div className="hidden sm:block absolute top-10 -left-4 md:-left-8 bg-white rounded-2xl shadow-2xl p-3 md:p-4 w-48 md:w-56 animate-float z-20">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 md:w-10 md:h-10 bg-slate-900 rounded-full flex items-center justify-center">
                    <Users className="w-4 h-4 md:w-5 md:h-5 text-white" />
                  </div>
                  <div className="flex-1">
                    <div className="text-xs md:text-sm font-semibold text-slate-900">Customer Support</div>
              ...
              <div className="hidden md:block absolute bottom-32 -left-8 lg:-left-12 bg-white rounded-2xl shadow-xl p-3 animate-float">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-br from-indigo-500 to-blue-400 rounded-full"></div>
                  <div className="w-16 md:w-20 h-1.5 bg-blue-500 rounded-full"></div>
                </div>
                <div className="text-xs font-semibold mt-2 text-slate-900">About the company</div>
              </div>

              <div className="hidden sm:block absolute top-40 -right-4 md:-right-8 bg-white rounded-2xl shadow-2xl p-3 md:p-4 w-44 md:w-52 animate-float z-20">
                <div className="flex items-center gap-3">
              ...
              {/* Chat Widget */}
              <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-500">
                <div className="bg-gradient-to-r from-indigo-600 to-blue-500 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                ...
                <div className="p-4 sm:p-6 space-y-3 sm:space-y-4 bg-gradient-to-b from-slate-50 to-white min-h-[300px] sm:min-h-[400px]">
                  ...
                  <div className="space-y-2">
                    ...
                    {[
                      ...
                      <div 
                        key={i}
                        className="bg-gradient-to-r from-indigo-600 to-blue-500 text-white rounded-xl sm:rounded-2xl px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm hover:shadow-lg transition-shadow cursor-pointer animate-slide-up"
                  ...
                  <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-slate-200 p-2 sm:p-3 flex items-center gap-2 sm:gap-3">
                    ...
                    <input 
                      ...
                      className="flex-1 outline-none text-xs sm:text-sm text-slate-600 placeholder:text-slate-400"
                    />
      ...
      {/* Brand Logos Section */}
      <div className="py-6 sm:py-10 bg-white/50 backdrop-blur-sm border-y border-slate-100 ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 sm:gap-8 md:gap-12 items-center justify-items-center opacity-60 grayscale hover:grayscale-0 transition-all duration-700">
            <div className="flex items-center gap-1 sm:gap-2 group cursor-pointer">
              <div className="h-4 sm:h-5 md:h-6 w-auto">
              ...
              <span className="text-sm sm:text-base md:text-xl font-bold text-slate-500 group-hover:text-slate-900 transition-colors">Stripe</span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2 group cursor-pointer">
              <div className="h-4 sm:h-5 md:h-6 w-auto">
              ...
              <span className="text-sm sm:text-base md:text-xl font-bold text-slate-500 group-hover:text-slate-900 transition-colors">Airbnb</span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2 group cursor-pointer">
              <div className="h-4 sm:h-5 md:h-6 w-auto">
              ...
              <span className="text-sm sm:text-base md:text-xl font-bold text-slate-500 group-hover:text-slate-900 transition-colors">Discord</span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2 group cursor-pointer">
              <div className="h-4 sm:h-5 md:h-6 w-auto">
              ...
              <span className="text-sm sm:text-base md:text-xl font-bold text-slate-500 group-hover:text-slate-900 transition-colors">Intercom</span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2 group cursor-pointer col-span-2 sm:col-span-1">
              <div className="h-4 sm:h-5 md:h-6 w-auto">
              ...
              <span className="text-sm sm:text-base md:text-xl font-bold text-slate-500 group-hover:text-slate-900 transition-colors">Pinterest</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 overflow-visible pt-0 ">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          {/* Visual Side (Left) */}
          <div className="relative order-2 lg:order-1">
            {/* Main Abstract Image */}
            <div className="relative w-[80%] sm:w-[85%] mx-auto lg:mx-0 aspect-[4/5] rounded-[1.5rem] sm:rounded-[2.5rem] overflow-hidden shadow-2xl bg-slate-100">
              <img 
            ...
            <div className="absolute -bottom-8 sm:-bottom-12 right-0 sm:right-4 lg:right-0 w-[45%] sm:w-[55%] aspect-[4/5] rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden shadow-2xl border-4 sm:border-8 border-white z-10 bg-slate-50">
              <img 
            ...
            <div className="hidden md:block absolute top-20 right-[5%] z-20 space-y-4">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            {[
              ...
              <div 
                key={index}
                className={`group relative aspect-[3/4] rounded-xl sm:rounded-2xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 ${card.bg}`}
              >
                {card.img && !card.solid && (
